...
export default function PopMessage(props) {
    return (
        <div className='pop-wrapper text-center w-[35vw] mx-auto rounded-md px-5'>
            ...
            <div className="proceed-btn mt-3 mb-5">
                <button className="background-grad py-[0.69rem] mt-2 w-9/12 text-white text-sm font-semibold rounded-sm" onClick={props.clickFunction}>
                    {props.content}
                </button>
            </div>
        </div>
